...
var M_nice = ["MEMORABLE!", "MARVELOUS!", "MAGNETIC!"];
var E_nice = ["EARNEST!", "EXCEPTIONAL!", "ENDEARING!"];
var G_nice = ["GENIUS!", "GREAT!", "GOOD!"];
var M_evil = ["MAANTUKIN!", "MATANDA!"];
var E_evil = ["EVIL!"];
var G_evil = ["GLUTTONOUS!", "GAY!", "GYATT!!!!!", "GUTOM PALAGI!"];
standsForSwitch();
